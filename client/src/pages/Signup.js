...
{/* Cards */}
  ...
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Aries"/>
      <div className="card-body">
  ...
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Taurus"/>
      <div className="card-body">
  ...
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Gemini"/>
      <div className="card-body">
  ...
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Cancer"/>
      <div className="card-body">
...
<div className="row row-cols-1 row-cols-md-4">
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Leo"/>
      <div className="card-body">
  ...
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Libra"/>
      <div className="card-body">
  ...
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Scorpio"/>
      <div className="card-body">
  ...
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Sagittarius"/>
      <div className="card-body">
  ...
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Capricorn"/>
      <div className="card-body">
  ...
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Aquarius"/>
      <div className="card-body">
  ...
  <div className="col mb-4">
    <div className="card">
      <img src="..." className="card-img-top" alt="Pisces"/>
      <div className="card-body">
